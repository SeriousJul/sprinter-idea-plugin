...
- Using JetBrains Marketplace:
  ...
  Go to [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/26036-sprinter) and install it by clicking the <kbd>Install to ...</kbd> button in case your IDE is running.

  You can also download the [latest release](https://plugins.jetbrains.com/plugin/26036-sprinter/versions) from JetBrains Marketplace and install it manually using
